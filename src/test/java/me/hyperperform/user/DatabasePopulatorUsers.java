 ...
 */
public class DatabasePopulatorUsers
{
    ...
    public void populateTest()
    {
        ...
        users.add(new User("avinash.singh@gmail.com", "Avinash", "avinashsingh", "Avinash", "Singh", "1234", null, EmployeeRole.Employee, Position.SoftwareDeveloper));
